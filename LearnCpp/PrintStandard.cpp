// This program prints the C++ language standard your compiler is using.
...
// Tutorial followed by Fayzan Kashem

#include <iostream>

const int numStandards = 7;
// The C++26 stdCode is a placeholder since the exact code won't be known until the standard is finalised
...
long getCPPStandard()
{
	...
	// In Visual Studio 2015 or newer we canuse _MSVC_LANG instead
